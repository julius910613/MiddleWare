...
angular.module('kitchensink', ['taxiService', 'customerService', 'contractService', 'remoteFlightCustomerService', 'remoteFlightQueryService','remoteFlightBookingService','contractDeleteService']).config(
