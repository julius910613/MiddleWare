...
angular.module('kitchensink', ['taxiService', 'customerService', 'contractService', 'remoteFlightCustomerService', 'remoteFlightQueryService','remoteFlightBookingService','contractDeleteService','remoteHotelCustomerService','remoteHotelsQueryService','remoteHotelBookingService']).config(
        [ '$routeProvider', function($routeProvider) {
            ...
            when('/home', {
                     ...
                     templateUrl : 'partials/taxihome.html',
