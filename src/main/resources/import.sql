...
insert into customer (id, name, password, driverLicenseID) values (0, 'John Smith', '091320117', '2125551212')
insert into customer (id, name, password, driverLicenseID) values (1, 'Zequn Li', '081340117', '2126651212')
insert into customer (id, name, password, driverLicenseID) values (2, 'Xin Wen', '101320711', '2125565465')
